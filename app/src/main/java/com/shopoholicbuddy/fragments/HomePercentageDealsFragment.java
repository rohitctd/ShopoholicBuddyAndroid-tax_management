...
public class HomePercentageDealsFragment extends Fragment implements OnMapReadyCallback, LocationsCallback, NetworkListener {
    ...
    private ArrayList<com.shopoholicbuddy.models.preferredcategorymodel.Result> percentageList;
...
//        AppUtils.getInstance().showHideViewWithAnimation(rvCategories, false);
        ...
        for (int i = 0; i < 10; i++) {
            com.shopoholicbuddy.models.preferredcategorymodel.Result result = new com.shopoholicbuddy.models.preferredcategorymodel.Result();
                    ...
                    case R.id.iv_like:
                        if (AppUtils.getInstance().isLoggedIn(mActivity) && AppUtils.getInstance().isInternetAvailable(mActivity)) {
                            ...
                            if (fragment instanceof HomeFragment) {
                                ((HomeFragment) fragment).changeFavouriteIcon(Constants.IntentConstant.PERCENTAGE, product.getId(), product.getIsBookmark());
                            }
                        }
                        break;
...
//            ((HomeActivity) mActivity).getFilterData().setDiscountPercentage(90);
